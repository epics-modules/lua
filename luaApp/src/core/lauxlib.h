...
LUALIB_API int LUA_SHARE (luaL_getmetafield) (lua_State *L, int obj, const char *e);
LUALIB_API int LUA_SHARE (luaL_callmeta) (lua_State *L, int obj, const char *e);
...
LUALIB_API const char * LUA_SHARE (luaL_checklstring) (lua_State *L, int arg,
                                                          size_t *l);
...
LUALIB_API void LUA_SHARE (luaL_checkstack) (lua_State *L, int sz, const char *msg);
...
LUALIB_API void LUA_SHARE (luaL_where) (lua_State *L, int lvl);
...
LUALIB_API int LUA_SHARE (luaL_loadbufferx) (lua_State *L, const char *buff, size_t sz,
                                   const char *name, const char *mode);
LUALIB_API int LUA_SHARE (luaL_loadstring) (lua_State *L, const char *s);

LUALIB_API lua_State * LUA_SHARE (luaL_newstate) (void);
